...
import { InventoryClothingItemView } from './InventoryClothingItemView';
import { InventoryClothingSearchView } from './InventoryClothingSearchView';

interface InventoryClothingViewProps
{
...
export const InventoryClothingView: FC<InventoryClothingViewProps> = props =>
{
    ...
    return (
        <Grid>
            <Column size={ 7 } overflow="hidden">
                <InventoryClothingSearchView groupItems={ groupItems } setGroupItems={ setFilteredGroupItems } />
                <AutoGrid columnCount={ 5 }>
                    { filteredGroupItems.length > 0 &&
                                            filteredGroupItems.map((item, index) =>
                                                <InventoryClothingItemView key={ index } groupItem={ item } />
                                            )
                                        }
                </AutoGrid>
            </Column>
